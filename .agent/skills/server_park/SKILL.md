...
# 🏗️ 서버 박 (Server Park) SKILL <!-- Updated: 2026-03-23 07:45 -->
...
- **대량 다국어 자동 번역 (KR)**: "Gemini 2.5 Pro를 사용하여 12개 이상의 언어를 단일 API 호출로 번역하고 DB에 일괄 동기화하는 스마트 배포 스크립트를 작성해줘." <!-- Updated: 2026-03-23 07:45 -->
- **DB 정밀 좌표 동기화 (KR)**: "구글 맵 서비스 API를 통해 기항지 랜드마크의 좌표를 소수점 6자리까지 고도화하고 로컬 DB와 NeonDB를 안전하게 매칭해줘." <!-- Updated: 2026-03-23 07:45 -->
