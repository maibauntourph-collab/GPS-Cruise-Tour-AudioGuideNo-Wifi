...
# 🎨 AI 수석 디자이너 (Designer Kim) SKILL <!-- Updated: 2026-02-23 18:43 -->
...
- **Glassmorphism 적용**: "인트로 페이지 버튼들을 거대한 유리 질감(Glassmorphism) 카드로 교체하고, 배경 이미지를 `generate_image`로 새로 생성해서 적용해줘."
- **레이아웃 최적화**: "모바일에서 `UnifiedFloatingCard`의 탭 리스트가 잘리지 않도록 고정 그리드를 제거하고 유연한 레이아웃을 적용해줘."
