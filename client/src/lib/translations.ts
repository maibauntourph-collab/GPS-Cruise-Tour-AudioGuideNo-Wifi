...
const uiTranslations: Record<string, Record<string, string>> = {
  ...
  ko: {
    ...
    chooseStartMethod: '여행을 시작할 방법을 선택하세요',
    startFromGPS: '현재 위치에서 시작',
    startFromGPSDesc: 'GPS로 현재 위치를 탐색하고 근처 관광지를 찾습니다',
    gettingGPS: 'GPS 위치 확인 중...',
    gpsSearch: 'GPS로 현재 위치를 탐색하고 근처 관광지를 찾습니다',
    gpsUnavailable: 'GPS를 사용할 수 없습니다. 도시를 수동으로 선택합니다',
    checking: '확인 중...',
