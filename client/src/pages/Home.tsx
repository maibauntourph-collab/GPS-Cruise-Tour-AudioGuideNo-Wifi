          ...
          <Tooltip>
            <TooltipTrigger asChild>
              ...
              >
                ...
                <span className="hidden sm:inline text-xs">
                  {selectedLanguage === 'ko' ? '?꾩튂' : 'My Location'}
                </span>
              </Button>
            </TooltipTrigger>
            <TooltipContent>
          ...
          <PopoverContent className="w-80 p-2 z-[9999] max-h-[70vh] overflow-y-auto" align="start">
            ...
            <Tabs defaultValue="start" value={pointSelectionMode} onValueChange={(v) => setPointSelectionMode(v as 'start' | 'end' | 'time')}>
                ...
                <TabsContent value="time" className="space-y-3 mt-0">
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      {selectedLanguage === 'ko' ? '?꾩옱 ?쒓컙 ?ъ슜' : 'Use current time'}
                    </Button>

                    {/* Quick Time Presets */}
                    <div className="grid grid-cols-3 gap-1">
                      {[
                        { hour: 7, label: { ko: '?ㅼ쟾 7, en: '7 AM' } },
                        { hour: 9, label: { ko: '?ㅼ쟾 9, en: '9 AM' } },
                        { hour: 12, label: { ko: '?뺤삤', en: 'Noon' } },
                        { hour: 14, label: { ko: '?ㅽ썑 2, en: '2 PM' } },
                        { hour: 17, label: { ko: '?ㅽ썑 5, en: '5 PM' } },
                        { hour: 20, label: { ko: '?ㅽ썑 8, en: '8 PM' } },
                      ].map(({ hour, label }) => {
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="flex gap-1">
                        {[
                          { day: 0, label: { ko: ', en: 'Sun' } },
                          { day: 1, label: { ko: ', en: 'Mon' } },
                          { day: 2, label: { ko: ', en: 'Tue' } },
                          { day: 3, label: { ko: ', en: 'Wed' } },
                          { day: 4, label: { ko: '紐?, en: 'Thu' } },
                          { day: 5, label: { ko: '湲?, en: 'Fri' } },
                          { day: 6, label: { ko: ', en: 'Sat' } },
                        ].map(({ day, label }) => {
              ...
              <div className="ml-auto flex items-center gap-0.5 sm:gap-1">
                ...
                {/* [?곸슂] QR肄붾뱶 ?ㅼ튂 怨듭쑀 踰꾪듉 - ?대┃ ?ㅼ튂 QR肄붾뱶 ?ㅼ씠?쇰줈洹쒖떆 */}
                ...
                {!isMobile && (
                  <div className="flex items-center gap-0.5 sm:gap-1">
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p>{selectedLanguage === 'ko' ? 'QR肄붾뱶濡ㅼ튂/怨듭쑀' : 'Install/Share via QR Code'}</p>
                      </TooltipContent>
                    </Tooltip>
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <option value="ko">?쒓뎅/option>
                          ...
                          <option value="zh">訝?뻼</option>
                          <option value="ja">?ζ쑍沃?/option>
                            <option value="pt">Portugu챗s</option>
                            ...
                            <div className="relative w-full overflow-hidden rounded-3xl bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl border border-white/20 transition-all animate-in fade-in zoom-in-95 duration-500">
                              ...
                              <div className="p-10 text-center">
                                ...
                                <div className="flex flex-col gap-4">
                                  ...
                                  >
                                    <QrCode className="w-4 h-4" />
                                    {language === 'ko' ? 'QR肄붾뱶濡ㅼ튂/怨듭쑀' : 'Install/Share via QR Code'}
                                  </Button>
                        ...
                        <div className="flex flex-col items-center gap-4 py-4">
                          <div className="flex items-center gap-2 text-purple-600 dark:text-purple-400">
                            ...
                            <h2 className="text-lg font-bold">
                              {selectedLanguage === 'ko' ? '?ㅼ튂 / 怨듭쑀' : 'Install / Share App'}
                            </h2>
                          </div>
                          <p className="text-sm text-muted-foreground text-center">
                            {selectedLanguage === 'ko'
                              ? '?꾨옒 QR肄붾뱶瑜ㅼ틪?섍굅留곹겕瑜?怨듭쑀?섏뿬 ?깆쓣 ?ㅼ튂?섏꽭
                              : 'Scan the QR code or share the link to install the app'}
                          </p>
                          {/* [?곸슂] QR肄붾뱶 ?대?吏 qrserver.com API瑜쒖슜?섏뿬 ?꾩옱 URL濡?QR ?대?吏 ?앹꽦 */}
