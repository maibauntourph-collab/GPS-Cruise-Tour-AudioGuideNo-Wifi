...
export default function LandmarkDetailDialog({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleDialogClose} modal={false}>
      <DialogContent
        className="h-[92dvh] sm:h-auto max-h-[92dvh] sm:max-h-[90vh] p-0 overflow-hidden flex flex-col border-none shadow-2xl bg-white/95 backdrop-blur-md rounded-t-[32px] sm:rounded-[32px] bottom-0 sm:bottom-auto w-[100vw] sm:w-[90vw] sm:max-w-5xl no-overlay"
      >
