...
**UI/UX Decisions:**
- **Design System:** Uses category-specific color coding: Landmarks (terracotta hsl(14, 85%, 55%)), Activities (blue hsl(210, 85%, 55%)), Restaurants (green hsl(142, 71%, 45%)), and Gift Shops (purple hsl(280, 65%, 55%)). All colors are consistently applied across markers, buttons, and UI elements.
