...
export const LANDMARKS: Landmark[] = [
  {
    ...
    translations: {
      ...
      it: {
        ...
        narration: "Benvenuti alla Galleria Borghese, sede di una delle collezioni d'arte più incredibili al mondo.",
        description: "Un museo d'arte di fama mondiale ospitato in una villa del XVII secolo.",
        detailedDescription: "The Borghese Gallery (Galleria Borghese) is an art gallery in Rome, Italy, housed in the former Villa Borghese Pinciana. It holds a substantial part of the Borghese collection of paintings, sculpture and antiquities, begun by Cardinal Scipione Borghese, the nephew of Pope Paul V. You can find masterpieces by Bernini, Caravaggio, and Canova. The surrounding park, Villa Borghese, is the third largest public park in Rome."
      }
    }
  },
  ...
  },
  {
    ...
    photos: [
      '/images/landmarks/roman_forum.png',
    ...
    translations: {
      ...
      ko: {
        name: '로마 포럼',
        narration: '고대 로마의 심장부인 로마 포럼에 오신 것을 환영합니다. 이곳은 한때 제국의 정치, 상업, 사법의 중심지였습니다. 특히 베스타 신전에서는 베스타 신녀들이 로마의 영원한 불꽃을 지켰던 신성한 역사를 느낄 수 있습니다.',
        description: '고대 로마 공공 생활의 중심지였던 역사적인 광장',
        detailedDescription: '라틴어로 포룸 로마눔(Forum Romanum)으로 알려진 로마 포럼은 고대 로마의 심장부이자 세계에서 가장 중요한 고고학 유적지 중 하나입니다. 천 년 넘게 이 직사각형 광장은 로마 공공 생활의 중심지였으며, 로마 공화국과 제국의 흥망성쇠를 지켜보았습니다. 원래 팔라티노 언덕과 캄피돌리오 언덕 사이의 습지였던 이 지역은 기원전 7세기에 배수되어 로마의 중앙 시장이자 모임 장소로 변모했습니다. 이곳에서는 개선식, 정치 집회, 재판 등이 열렸으며, 베스타 신녀들이 지키는 성스러운 불꽃이 있던 베스타 신전은 로마 자체의 영원성을 상징했습니다. 오늘날 로마 포럼을 걷는 것은 마치 시간을 되돌리는 것과 같으며, 모든 기둥, 아치, 돌 하나하나가 고대 로마의 영광과 권력의 이야기를 들려줍니다.',
        historicalInfo: '로마 중심부에 있는 타원형 광장으로 원래는 습지였으나 배수 시설(Cloaca Maxima)을 통해 로마 공공 생활의 중심지로 발전했습니다. 율리우스 카이사르와 아우구스투스 황제 시절에 가장 전성기를 누렸습니다.',
        yearBuilt: '기원전 7세기 - 서기 4세기',
        architect: '여러 로마 황제 및 건축가'
      },
      es: {
        name: 'Foro Romano',
  ...
  },
  {
    ...
    photos: [
      '/images/landmarks/trevi_fountain.png',
      'https://images.unsplash.com/photo-1525874684015-58379d421a52?w=800',
      'https://images.unsplash.com/photo-1529260830199-42c24126f198?w=800',
      'https://images.unsplash.com/photo-1548585744-4e87a0e84c88?w=800',
      'https://images.unsplash.com/photo-1569154941061-e231b4725ef1?w=800',
  ...
  // Rome Gift Shops
  {
    ...
    translations: {
      ...
      es: { name: 'Galería de Souvenirs Borghese', narration: 'Tienda de regalos premium cerca de la Escalinata Española con artículos de cuero italiano, souvenirs del Vaticano y joyería artesanal. Tarjetas de crédito aceptadas, compras libres de impuestos disponibles.', description: 'Tienda de regalos de lujo especializada en cuero italiano, recuerdos vaticanos y joyería artesanal', detailedDescription: 'Ubicada a pasos de la Escalinata Española, la Galería de Souvenirs Borghese ofrece souvenirs y regalos italianos de primera calidad. Las especialidades incluyen bolsos y carteras de cuero italiano genuino, merchandising oficial de la Ciudad del Vaticano, joyería artesanal de cristal de Murano, artefactos religiosos y rosarios, decoración del hogar con tema romano y productos alimenticios italianos auténticos. Métodos de pago: Visa, Mastercard, Amex, UnionPay, Alipay, WeChat Pay y efectivo (EUR/USD). Compras libres de impuestos para turistas no pertenecientes a la UE.' },
      fr: { name: 'Galerie de Souvenirs Borghese', narration: 'Boutique de cadeaux haut de gamme près des Escaliers Espagnols proposant des articles en cuir italien, des souvenirs du Vatican et des bijoux artisanaux. Cartes de crédit acceptées, shopping hors taxes disponible.', description: 'Boutique de cadeaux haut de gamme spécialisée dans le cuir italien, les souvenirs du Vatican et les bijoux artisanaux', detailedDescription: 'Située à quelques pas des Escaliers Espagnols, la Galerie de Souvenirs Borghese propose des souvenirs et cadeaux italiens haut de gamme. Les spécialités comprennent des sacs et portefeuilles en cuir italien véritable, des produits officiels de la Cité du Vatican, des bijoux artisanaux en verre de Murano, des artefacts religieux et des rosaires, des décorations intérieures sur le thème romain et des produits alimentaires italiens authentiques. Modes de paiement acceptés: Visa, Mastercard, Amex, UnionPay, Alipay, WeChat Pay et espèces (EUR/USD). Shopping détaxé pour les touristes hors UE.' },
      de: { name: 'Borghese Souvenir Galerie', narration: 'Premium-Geschenkeladen in der Nähe der Spanischen Treppe mit italienischen Lederwaren, Vatikan-Souvenirs und handgefertigtem Schmuck. Kreditkarten akzeptiert, steuerfreies Einkaufen verfügbar.', description: 'Gehobener Souvenirladen spezialisiert auf italienisches Leder, Vatikan-Memorabilia und handwerklichen Schmuck', detailedDescription: 'Nur wenige Schritte von der Spanischen Treppe entfernt bietet die Borghese Souvenir Galerie Premium-Souvenirs und Geschenke aus Italien. Zu den Spezialitäten gehören echte italienische Ledertaschen und Geldbörsen, offizielle Vatikanstadt-Merchandise, handgefertigter Murano-Glasschmuck, religiöse Artefakte und Rosenkränze, römische Heimdekoration und authentische italienische Lebensmittel. Akzeptierte Zahlungsmethoden: Visa, Mastercard, Amex, UnionPay, Alipay, WeChat Pay und Bargeld (EUR/USD). Steuerfreies Einkaufen für Nicht-EU-Touristen verfügbar.' },
      zh: { name: '博尔盖塞纪念品画廊', narration: '西班牙台阶附近的高级礼品店，提供意大利皮具、梵蒂冈纪念品和手工珠宝。接受信用卡，提供免税购物。', description: '专营意大利皮具、梵蒂冈纪念品和工艺珠宝的高档礼品店', detailedDescription: '博尔盖塞纪念品画廊位于西班牙台阶附近，提供优质意大利纪念品和礼品。特色商品包括正宗意大利皮革包和钱包、梵蒂冈官方商品、手工穆拉诺玻璃珠宝、宗教文物和念珠、罗马主题家居装饰以及正宗意大利食品。接受支付方式：Visa、Mastercard、Amex、银联、支付宝、微信支付以及现金（欧元/美元）。为非欧盟游客提供免税购物。' },
      ja: { name: 'ボルゲーゼ土産ギャラリー', narration: 'スペイン広場近くのプレミアムギフトショップで、イタリアンレザー製品、バチカンお土産、手作りジュエリーを取り扱っています。クレジットカード利用可、免税ショッピング可能。', description: 'イタリアンレザー、バチカン記念品、職人ジュエリー専門の高級ギフトショップ', detailedDescription: 'スペイン広場からすぐの場所にあるボルゲーゼ土産ギャラリーでは、プレミアムなイタリアンお土産やギフトを提供しています。本物のイタリアンレザーバッグや財布、バチカン市国公式グッズ、手作りムラーノガラスジュエリー、宗教的工芸品とロザリオ、ローマテーマのホームデコ、本格的なイタリア食品を取り揃えています。Visa、Mastercard、Amex、UnionPay、Alipay、WeChat Pay、現金（EUR/USD）でお支払いいただけます。EU外の観光客向け免税ショッピングあり。' },
      pt: { name: 'Galeria de Souvenirs Borghese', narration: 'Loja de presentes premium perto da Escadaria da Piazza di Spagna com artigos de couro italiano, souvenirs do Vaticano e joias artesanais. Cartões de crédito aceitos, compras isentas de impostos disponíveis.', description: 'Loja de presentes de alta qualidade especializada em couro italiano, lembranças do Vaticano e joias artesanais', detailedDescription: 'Localizada a poucos passos da Escadaria da Piazza di Spagna, a Galeria de Souvenirs Borghese oferece souvenirs e presentes italianos premium. As especialidades incluem bolsas e carteiras de couro italiano genuíno, merchandising oficial da Cidade do Vaticano, joias artesanais em vidro de Murano, artefatos religiosos e rosários, decoração para casa com tema romano e produtos alimentícios italianos autênticos. Formas de pagamento aceitas: Visa, Mastercard, Amex, UnionPay, Alipay, WeChat Pay e dinheiro (EUR/USD). Compras isentas de impostos para turistas de fora da UE.' },
      ru: { name: 'Галерея сувениров Боргезе', narration: 'Премиальный сувенирный магазин возле Испанской лестницы с итальянскими кожаными изделиями, ватиканскими сувенирами и ювелирными украшениями ручной работы. Принимаются кредитные карты, доступен беспошлинный шопинг.', description: 'Элитный сувенирный магазин, специализирующийся на итальянской коже, ватиканских сувенирах и ювелирных украшениях ручной работы', detailedDescription: 'Расположенная в нескольких шагах от Испанской лестницы, Галерея сувениров Боргезе предлагает премиальные итальянские сувениры и подарки. Фирменные товары включают подлинные итальянские кожаные сумки и кошельки, официальную продукцию Ватикана, ювелирные украшения ручной работы из муранского стекла, религиозные артефакты и чётки, домашний декор в римском стиле и аутентичные итальянские продукты. Принимаемые способы оплаты: Visa, Mastercard, Amex, UnionPay, Alipay, WeChat Pay и наличные (EUR/USD). Беспошлинный шопинг для туристов из-за пределов ЕС.' }
    }
  },
  {
    ...
    translations: {
      ...
      es: { name: 'Tienda Tesoros Vaticanos', narration: 'Tienda oficial de souvenirs del Vaticano que ofrece rosarios bendecidos, recuerdos papales y arte religioso. Se aceptan pagos en múltiples monedas. Artículos exclusivos bendecidos por el Papa.', description: 'Souvenirs religiosos, regalos papales y artículos bendecidos por el Vaticano', detailedDescription: 'La Tienda Tesoros Vaticanos ofrece auténticos souvenirs vaticanos y religiosos. Nuestra colección incluye rosarios y cruces bendecidos por el Papa, medallas conmemorativas de la Ciudad del Vaticano, reproducciones de arte religioso e iconos, merchandising de la Capilla Sixtina, estatuas y figuritas de santos, y bendiciones papales y certificados. Todos los artículos vienen con certificados de autenticidad. Aceptamos todas las tarjetas de crédito principales y PayPal. Socio oficial del programa de souvenirs de la Ciudad del Vaticano.' },
      fr: { name: 'Boutique Trésors du Vatican', narration: 'Boutique officielle de souvenirs du Vatican proposant des chapelets bénis, des souvenirs papaux et de l\'art religieux. Paiements multidevises acceptés. Articles exclusifs bénis par le Pape.', description: 'Souvenirs religieux, cadeaux papaux et articles bénis par le Vatican', detailedDescription: 'La Boutique Trésors du Vatican propose d\'authentiques souvenirs du Vatican et religieux. Notre collection comprend des chapelets et croix bénis par le Pape, des médailles commémoratives de la Cité du Vatican, des reproductions d\'art religieux et d\'icônes, des produits de la Chapelle Sixtine, des statues et figurines de saints, et des bénédictions papales et certificats. Tous les articles sont accompagnés de certificats d\'authenticité. Nous acceptons toutes les principales cartes de crédit et PayPal. Partenaire officiel du programme de souvenirs de la Cité du Vatican.' },
      de: { name: 'Vatikanische Schätze Laden', narration: 'Offizieller Vatikan-Souvenirladen mit gesegneten Rosenkränzen, päpstlichen Andenken und religiöser Kunst. Multiwährungs-Zahlungen akzeptiert. Exklusive vom Papst gesegnete Artikel.', description: 'Religiöse Souvenirs, päpstliche Geschenke und vom Vatikan gesegnete Artikel', detailedDescription: 'Der Vatikanische Schätze Laden bietet authentische vatikanische und religiöse Souvenirs. Unsere Kollektion umfasst vom Papst gesegnete Rosenkränze und Kreuze, Gedenkmedaillen der Vatikanstadt, Reproduktionen religiöser Kunst und Ikonen, Sixtinische Kapelle Merchandise, Heiligenstatuen und Figuren sowie päpstliche Segnungen und Zertifikate. Alle Artikel werden mit Echtheitszertifikaten geliefert. Wir akzeptieren alle gängigen Kreditkarten und PayPal. Offizieller Partner des Vatikanstadt-Souvenir-Programms.' },
      zh: { name: '梵蒂冈珍宝店', narration: '官方梵蒂冈纪念品商店，提供祝圣念珠、教皇纪念品和宗教艺术品。接受多种货币支付。教皇祝福的独家商品。', description: '宗教纪念品、教皇礼品和梵蒂冈祝福物品', detailedDescription: '梵蒂冈珍宝店提供正宗的梵蒂冈和宗教纪念品。我们的收藏包括教皇祝福的念珠和十字架、梵蒂冈城纪念章、宗教艺术品和圣像复制品、西斯廷教堂商品、圣徒雕像和雕塑像、教皇祝福书和证书。所有商品均附有真品证书。接受所有主要信用卡和PayPal。梵蒂冈城纪念品计划官方合作伙伴。' },
      ja: { name: 'バチカン宝物店', narration: '祝福されたロザリオ、教皇記念品、宗教美術を提供する公式バチカン土産店。多通貨支払い可能。教皇に祝福された限定商品。', description: '宗教土産、教皇ギフト、バチカン祝福アイテム', detailedDescription: 'バチカン宝物店では、本物のバチカンと宗教的なお土産を提供しています。コレクションには、教皇祝福のロザリオと十字架、バチカン市国記念メダル、宗教芸術とイコン複製品、システィーナ礼拝堂グッズ、聖人像とフィギュア、教皇祝福証書などが含まれます。すべての商品に真正証明書が付属。すべての主要クレジットカードとPayPalを受け付けています。バチカン市国土産プログラム公式パートナー。' },
      pt: { name: 'Loja Tesouros do Vaticano', narration: 'Loja oficial de souvenirs do Vaticano oferecendo rosários abençoados, lembranças papais e arte religiosa. Pagamentos em múltiplas moedas aceitos. Itens exclusivos abençoados pelo Papa.', description: 'Souvenirs religiosos, presentes papais e itens abençoados pelo Vaticano', detailedDescription: 'A Loja Tesouros do Vaticano oferece autênticos souvenirs do Vaticano e religiosos. Nossa coleção inclui rosários e cruzes abençoados pelo Papa, medalhas comemorativas da Cidade do Vaticano, reproduções de arte religiosa e ícones, merchandising da Capela Sistina, estátuas e estatuetas de santos, e bênçãos papais e certificados. Todos os itens vêm com certificados de autenticidade. Aceitamos todos os principais cartões de crédito e PayPal. Parceiro oficial do programa de souvenirs da Cidade do Vaticano.' },
      ru: { name: 'Магазин сокровищ Ватикана', narration: 'Официальный магазин сувениров Ватикана, предлагающий освящённые чётки, папские сувениры и религиозное искусство. Принимаются платежи в разных валютах. Эксклюзивные товары, освящённые Папой.', description: 'Религиозные сувениры, папские подарки и освящённые Ватиканом предметы', detailedDescription: 'Магазин сокровищ Ватикана предлагает подлинные ватиканские и религиозные сувениры. Наша коллекция включает благословленные Папой чётки и кресты, памятные медали Ватикана, репродукции религиозного искусства и икон, товары Сикстинской капеллы, статуэтки и фигурки святых, папские благословения и сертификаты. Все товары сопровождаются сертификатами подлинности. Принимаем все основные кредитные карты и PayPal. Официальный партнёр программы сувениров Ватикана.' }
    }
  },
  {
    ...
    translations: {
      ...
      es: { name: 'Recuerdos del Coliseo', narration: 'Souvenirs romanos icónicos junto al Coliseo. Cascos de gladiador, réplicas de monedas romanas y cerámicas italianas. Visa, Mastercard, Amex aceptadas. Descuentos especiales de invierno disponibles.', description: 'Souvenirs temáticos del Coliseo, réplicas romanas y cerámicas italianas', detailedDescription: 'Recuerdos del Coliseo ofrece auténticos souvenirs y regalos de tema romano ubicados junto al antiguo anfiteatro. Nuestra colección incluye réplicas de alta calidad de cascos de gladiador, reproducciones de monedas romanas, auténticas cerámicas italianas, joyería inspirada en la antigua Roma, libros históricos y guías, y miniaturas y modelos del Coliseo. Todas las réplicas son de calidad museística con artesanía detallada. Enviamos a todo el mundo y ofrecemos servicios de envoltura de regalos. Descuentos especiales para grupos turísticos disponibles.' },
      fr: { name: 'Souvenirs du Colisée', narration: 'Souvenirs romains emblématiques à côté du Colisée. Casques de gladiateur, répliques de pièces romaines et céramiques italiennes. Visa, Mastercard, Amex acceptées. Réductions hivernales spéciales disponibles.', description: 'Souvenirs sur le thème du Colisée, répliques romaines et céramiques italiennes', detailedDescription: 'Souvenirs du Colisée propose d\'authentiques souvenirs et cadeaux romains situés juste à côté de l\'ancien amphithéâtre. Notre collection comprend des répliques de haute qualité de casques de gladiateur, des reproductions de pièces romaines, d\'authentiques céramiques italiennes, des bijoux inspirés de la Rome antique, des livres historiques et des guides, et des miniatures et maquettes du Colisée. Toutes les répliques sont de qualité muséale avec un artisanat détaillé. Nous expédions dans le monde entier et offrons des services d\'emballage cadeau. Réductions spéciales pour groupes touristiques disponibles.' },
      de: { name: 'Kolosseum Erinnerungen', narration: 'Ikonische römische Souvenirs neben dem Kolosseum. Gladiatorenhelme, römische Münzrepliken und italienische Keramik. Visa, Mastercard, Amex akzeptiert. Spezielle Winterrabatte verfügbar.', description: 'Kolosseum-Souvenirs, römische Repliken und italienische Keramik', detailedDescription: 'Kolosseum Erinnerungen bietet authentische römische Souvenirs und Geschenke direkt neben dem antiken Amphitheater. Unsere Kollektion umfasst hochwertige Gladiatorenhelm-Repliken, römische Münzreproduktionen, authentische italienische Keramik, vom antiken Rom inspirierter Schmuck, historische Bücher und Reiseführer sowie Kolosseum-Miniaturen und Modelle. Alle Repliken sind in Museumsqualität mit detaillierter Handwerkskunst. Wir versenden weltweit und bieten Geschenkverpackungsservice. Spezielle Gruppenrabatte für Touren verfügbar.' },
      zh: { name: '斗兽场回忆', narration: '斗兽场旁的标志性罗马纪念品。角斗士头盔、罗马硬币复制品和意大利陶瓷。接受Visa、Mastercard、Amex。提供特别冬季折扣。', description: '斗兽场主题纪念品、罗马复制品和意大利陶瓷', detailedDescription: '斗兽场回忆提供正宗的罗马主题纪念品和礼品，位于古代圆形剧场旁边。我们的收藏包括高品质角斗士头盔复制品、罗马硬币仿制品、正宗意大利陶瓷、古罗马风格珠宝、历史书籍和指南以及斗兽场微缩模型。所有复制品都是博物馆级别的精致工艺。我们提供全球配送和礼品包装服务。团体旅游特别折扣。' },
      ja: { name: 'コロッセオメモリーズ', narration: 'コロッセオ隣の象徴的なローマ土産店。剣闘士ヘルメット、ローマコインレプリカ、イタリア陶器。Visa、Mastercard、Amex利用可。特別冬季割引あり。', description: 'コロッセオテーマのお土産、ローマレプリカ、イタリア陶器', detailedDescription: 'コロッセオメモリーズは、古代円形闘技場のすぐ隣にある本格的なローマテーマのお土産とギフトを提供しています。コレクションには高品質な剣闘士ヘルメットレプリカ、ローマコイン複製品、本物のイタリア陶器、古代ローマをインスピレーションにしたジュエリー、歴史書とガイドブック、コロッセオミニチュアとモデルが含まれます。すべてのレプリカは詳細な職人技による博物館品質です。世界中への配送とギフトラッピングサービスを提供。ツアーグループ向け特別割引あり。' },
      pt: { name: 'Memórias do Coliseu', narration: 'Souvenirs romanos icônicos ao lado do Coliseu. Capacetes de gladiador, réplicas de moedas romanas e cerâmicas italianas. Visa, Mastercard, Amex aceitos. Descontos especiais de inverno disponíveis.', description: 'Souvenirs temáticos do Coliseu, réplicas romanas e cerâmicas italianas', detailedDescription: 'Memórias do Coliseu oferece autênticos souvenirs e presentes com tema romano localizados ao lado do antigo anfiteatro. Nossa coleção inclui réplicas de alta qualidade de capacetes de gladiador, reproduções de moedas romanas, cerâmicas italianas autênticas, joias inspiradas na Roma antiga, livros históricos e guias, e miniaturas e modelos do Coliseu. Todas as réplicas são de qualidade de museu com artesanato detalhado. Enviamos para todo o mundo e oferecemos serviços de embrulho para presente. Descontos especiais para grupos turísticos disponíveis.' },
      ru: { name: 'Воспоминания о Колизее', narration: 'Культовые римские сувениры рядом с Колизеем. Шлемы гладиаторов, копии римских монет и итальянская керамика. Принимаются Visa, Mastercard, Amex. Доступны специальные зимние скидки.', description: 'Сувениры на тему Колизея, римские копии и итальянская керамика', detailedDescription: 'Воспоминания о Колизее предлагает подлинные римские сувениры и подарки прямо рядом с древним амфитеатром. Наша коллекция включает высококачественные копии гладиаторских шлемов, репродукции римских монет, подлинную итальянскую керамику, украшения в стиле древнего Рима, исторические книги и путеводители, а также миниатюры и модели Колизея. Все копии выполнены в музейном качестве с детальным мастерством. Мы отправляем по всему миру и предлагаем услуги подарочной упаковки. Специальные групповые скидки для туров.' }
    }
  },
  {
    ...
    translations: {
      ...
      es: { name: 'Tesoros Artesanales de Trastevere', narration: 'Artesanía local auténtica en el corazón de Trastevere. Artículos de cuero hechos a mano, cerámica artesanal y aceites de oliva locales. Se prefiere efectivo, tarjetas aceptadas. ¡Apoya a los artesanos locales!', description: 'Cuero artesanal, cerámica artesanal y artesanías romanas tradicionales', detailedDescription: 'Tesoros Artesanales de Trastevere presenta lo mejor de la artesanía romana en el encantador barrio de Trastevere. Nuestra colección cuidadosamente seleccionada incluye accesorios de cuero italiano hechos a mano, cerámica y terracota romana tradicional, aceites de oliva y vinagres balsámicos producidos localmente, jabones y fragancias artesanales, azulejos y decoraciones pintados a mano, y joyería de estilo romano vintage. Trabajamos directamente con artesanos locales para ofrecerte piezas auténticas y únicas. Certificados de regalo disponibles. Apoya a los artesanos italianos locales con cada compra.' },
      fr: { name: 'Trésors Artisanaux du Trastevere', narration: 'Artisanat local authentique au cœur du Trastevere. Maroquinerie faite main, poterie artisanale et huiles d\'olive locales. Espèces préférées, cartes acceptées. Soutenez les artisans locaux!', description: 'Cuir artisanal, poterie artisanale et artisanat romain traditionnel', detailedDescription: 'Trésors Artisanaux du Trastevere présente le meilleur de l\'artisanat romain dans le charmant quartier du Trastevere. Notre collection soigneusement sélectionnée comprend des accessoires en cuir italien faits main, des céramiques et poteries romaines traditionnelles, des huiles d\'olive et vinaigres balsamiques produits localement, des savons et parfums artisanaux, des carreaux et décorations peints à la main, et des bijoux de style romain vintage. Nous travaillons directement avec les artisans locaux pour vous proposer des pièces authentiques et uniques. Chèques-cadeaux disponibles. Soutenez les artisans italiens locaux à chaque achat.' },
      de: { name: 'Trastevere Kunsthandwerk Schätze', narration: 'Authentisches lokales Kunsthandwerk im Herzen von Trastevere. Handgefertigte Lederwaren, handwerkliche Keramik und lokale Olivenöle. Bargeld bevorzugt, Karten akzeptiert. Unterstützen Sie lokale Handwerker!', description: 'Handgefertigtes Leder, Kunsthandwerk-Keramik und traditionelles römisches Handwerk', detailedDescription: 'Trastevere Kunsthandwerk Schätze präsentiert das Beste des römischen Handwerks im charmanten Trastevere-Viertel. Unsere sorgfältig kuratierte Kollektion umfasst handgefertigte italienische Lederaccessoires, traditionelle römische Keramik und Töpferwaren, lokal produzierte Olivenöle und Balsamico-Essige, handwerkliche Seifen und Düfte, handbemalte Fliesen und Dekorationen sowie Vintage-Schmuck im römischen Stil. Wir arbeiten direkt mit lokalen Handwerkern zusammen, um Ihnen authentische, einzigartige Stücke zu bringen. Geschenkgutscheine verfügbar. Unterstützen Sie lokale italienische Handwerker bei jedem Kauf.' },
      zh: { name: '特拉斯提弗列工匠宝藏', narration: '特拉斯提弗列中心的正宗当地工艺品。手工皮具、工匠陶器和当地橄榄油。优先现金，接受银行卡。支持当地工匠！', description: '手工皮革、工匠陶器和传统罗马工艺品', detailedDescription: '特拉斯提弗列工匠宝藏在迷人的特拉斯提弗列社区展示最优质的罗马工艺。我们精心策划的收藏包括手工意大利皮革配饰、传统罗马陶器和瓷器、当地生产的橄榄油和香醋、手工皂和香水、手绘瓷砖和装饰品以及复古罗马风格珠宝。我们直接与当地工匠合作，为您带来正宗独特的作品。提供礼品券。每次购买都支持意大利当地工匠。' },
      ja: { name: 'トラステヴェレ職人の宝物', narration: 'トラステヴェレの中心部にある本格的な地元工芸品。手作りレザーグッズ、職人陶器、地元のオリーブオイル。現金優先、カード可。地元の職人を応援しよう！', description: '手作りレザー、職人陶器、伝統的なローマ工芸品', detailedDescription: 'トラステヴェレ職人の宝物は、魅力的なトラステヴェレ地区でローマ工芸の最高峰を紹介しています。厳選されたコレクションには、手作りイタリアンレザーアクセサリー、伝統的なローマ陶器と磁器、地元産オリーブオイルとバルサミコ酢、職人石鹸とフレグランス、手描きタイルと装飾品、ヴィンテージローマスタイルジュエリーが含まれます。地元の職人と直接協力して、本物のユニークな作品をお届けします。ギフト券利用可能。ご購入ごとにイタリアの地元職人をサポート。' },
      pt: { name: 'Tesouros Artesanais de Trastevere', narration: 'Artesanato local autêntico no coração de Trastevere. Artigos de couro feitos à mão, cerâmica artesanal e azeites locais. Preferência por dinheiro, cartões aceitos. Apoie os artesãos locais!', description: 'Couro artesanal, cerâmica artesanal e artesanato romano tradicional', detailedDescription: 'Tesouros Artesanais de Trastevere apresenta o melhor do artesanato romano no charmoso bairro de Trastevere. Nossa coleção cuidadosamente curada inclui acessórios de couro italiano feitos à mão, cerâmicas e olarias romanas tradicionais, azeites e vinagres balsâmicos produzidos localmente, sabonetes e fragrâncias artesanais, azulejos e decorações pintados à mão, e joias em estilo romano vintage. Trabalhamos diretamente com artesãos locais para trazer peças autênticas e únicas. Certificados de presente disponíveis. Apoie os artesãos italianos locais a cada compra.' },
      ru: { name: 'Ремесленные сокровища Трастевере', narration: 'Подлинные местные ремесла в сердце Трастевере. Кожаные изделия ручной работы, ремесленная керамика и местные оливковые масла. Предпочтительно наличные, карты принимаются. Поддержите местных мастеров!', description: 'Ручная кожа, ремесленная керамика и традиционные римские изделия', detailedDescription: 'Ремесленные сокровища Трастевере представляет лучшее римское мастерство в очаровательном районе Трастевере. Наша тщательно отобранная коллекция включает кожаные аксессуары ручной работы из Италии, традиционную римскую керамику и посуду, местные оливковые масла и бальзамический уксус, ремесленное мыло и ароматы, расписанную вручную плитку и украшения, а также винтажные украшения в римском стиле. Мы работаем напрямую с местными мастерами, чтобы предложить вам подлинные уникальные изделия. Подарочные сертификаты доступны. Поддержите местных итальянских мастеров каждой покупкой.' }
    }
  },
  {
