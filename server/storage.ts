  ...
  },
  {
    ...
    translations: {
      ...
      de: {
        ...
        detailedDescription: 'Das Pantheon steht als eines der am besten erhaltenen antiken Gebäude Roms und repräsentiert den Höhepunkt römischer Ingenieurskunst und architektonischen Designs. Ursprünglich als Tempel erbaut, der allen Göttern des römischen Pantheons gewidmet war, ist dieses bemerkenswerte Bauwerk seit fast zwei Jahrtausenden ununterbrochen in Gebrauch und dient seit dem 7. Jahrhundert als katholische Kirche. Das heutige Gebäude wurde um 126 n. Chr. unter Kaiser Hadrian fertiggestellt. Das beeindruckendste Merkmal des Pantheons ist seine außergewöhnliche Kuppel aus unbewehrtem Beton, die mit einem Innendurchmesser von 43,3 Metern die größte unbewehrte Betonkuppel der Welt bleibt. Der Oculus, eine 8,7 Meter große kreisförmige Öffnung an der Spitze der Kuppel, ist die einzige natürliche Lichtquelle des Innenraums. Das Pantheon beherbergt die Gräber mehrerer berühmter Italiener, darunter der Renaissance-Künstler Raphael.',
  ...
  },
  {
    ...
    translations: {
      ...
      fr: {
        ...
        detailedDescription: 'Le Château Saint-Ange, construit à l\'origine comme mausolée pour l\'empereur Hadrien, a servi de nombreux objectifs dont forteresse, prison, résidence papale et maintenant musée. La structure cylindrique a été commandée en 123 après J.-C. Son nom provient d\'une légende de 590, lorsque le pape Grégoire Ier aurait vu l\'archange Michel rengainant son épée. Les visiteurs peuvent monter sur la terrasse avec vues panoramiques sur Rome.',
      ...
      de: {
        ...
        detailedDescription: 'Die Engelsburg, ursprünglich als Mausoleum für Kaiser Hadrian erbaut, hat zahlreichen Zwecken gedient, darunter Festung, Gefängnis, päpstliche Residenz und heute Museum. Die zylindrische Struktur wurde 123 n. Chr. in Auftrag gegeben. Ihr Name stammt aus einer Legende von 590, als Papst Gregor I. den Erzengel Michael sah, der sein Schwert einsteckte. Besucher können zur Terrasse mit Panoramablick auf Rom aufsteigen.',
